  ...
  ?>
    ...
    <section>
        <div class="page-content">
            <form class="game" id='game' action="verifyalgebra.php" method="POST"> 
                <h3>Calculati ecuatiile de mai jos(Scrieti doar valoare finala a lui x)</h3>
                <?php
                $exercises = [];
                $exercises = getAlgebra();
